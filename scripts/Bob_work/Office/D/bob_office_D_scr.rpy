screen bob_office_D_scr:
    ...
    imagebutton:
        ...
        if clickable == True:
            hovered Show("displayTextScreen", displayText = "Статуя")
    ...
    imagebutton:
        ...
        if clickable == True:
            hovered Show("displayTextScreen", displayText = "Камин")
    ...
    imagebutton:
        ...
        if clickable == True:
            hovered Show("displayTextScreen", displayText = "Таблица")
    ...
    if zuri_magentcard in inventory.items and Bob_work_minigame == True:
        imagebutton:
            ...
            if clickable == True:
                hovered Show("displayTextScreen", displayText = "Сидеть на стуле")
    ...
    imagebutton:
        ...
        if clickable == True:
            hovered Show("displayTextScreen", displayText = "Книжный шкаф")
