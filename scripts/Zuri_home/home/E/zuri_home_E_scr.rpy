...
screen zuri_home_E_scr:
    ...
    if Zv2_ES1 == True:
        imagebutton:
            ...
            if clickable == True:
                hovered Show("displayTextScreen", displayText = "Сидеть на диване")
        ...
        imagebutton:
            ...
            if clickable == True:
                hovered Show("displayTextScreen", displayText = "Зури")
    ...
    if Zv2_ES2 == True:
        imagebutton:
            ...
            if clickable == True:
                hovered Show("displayTextScreen", displayText = "Зури и Сури")
