...
label cosplay_outfit1_label:
    ...
    if cosplay_outfit1_first_time == True:
        ...
        MC "Вау!"
        MC "(Я даже не уверен, что это косплей, она выглядит удивительно!)"
        Caroline "Как ты думаешь, это будет хорошо продаваться? Любые идеи о том, как продавать его?"
        MC "Да, это будет! Умм ... ты могли бы попробовать продать кучу, на День святого Валентина."
        Caroline "Отлично! Я обязательно закажу дополнительно на февраль."
        window hide
