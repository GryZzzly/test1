...
label cosplay_outfit2_label:
    ...
    if cosplay_outfit2_first_time == True:
        Caroline "Доброе утро, сэр [player_name]. Как дела?"
        MC "Все прекрасно!"
        Caroline "Я понял, что этот милый косплей Французской Горничной будет хорошо продаваться."
        MC "(Короткая юбка - отличное дополнение! У нее действительно сексуальные бедра!)"
