...
label cosplay_outfit3_label:
    ...
    if cosplay_outfit3_first_time == True:
        Caroline "Дальше, становиться намного интереснее - непослушная школьница!"
        MC "Прекрасный выбор! Чулки отлично смотрятся на тебе тоже."
        Caroline "Все, спасибо, [player_name]."
        Caroline "Это немного непристойной - но я думаю, что это то, в чем можно ходить."
        MC "Да, ты, прекрасная. Если бы у меня была подруга, я бы купил ей этот наряд!"
        Caroline "Ха-Ха! Мне действительно не хочеться слышать о твоих сексуальных фантазиях, [player_name]!"
