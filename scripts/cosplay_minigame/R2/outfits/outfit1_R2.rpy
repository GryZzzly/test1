...
label outfit1_R2_label:
    ...
    if outfit1_R2_1stTime == True:
        ...
        Caroline "Что ж? Как думаешь?"
        MC "Это круто! Не так сексуально или неряшливо, как твои другие костюмы, хотя..."
        Caroline "Да, я думал, что должен был расширить свой рынок. Если я могу получить постоянных клиентов, а также извращенцев, то они помогут увеличить мою прибыль."
        MC "Имеет ли это смысл!"
        Caroline "Хорошо! Готовы ли ты сделать несколько снимков?"
        MC "Я уверенный!"
        window hide
