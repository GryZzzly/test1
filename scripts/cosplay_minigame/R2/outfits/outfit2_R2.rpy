...
label outfit2_R2_label:
    ...
    if outfit2_R2_1stTime == True:
        ...
        Caroline "Этот ... немного смущает. Я не переодевалась в  болельщици со времен средней школы!"
        MC "В самом деле? Я думаю, ты сейчас раскачаешься, Кэролайн!"
        Caroline "ой...."
        MC "Хорошо, забастовка позже, начнем!"
