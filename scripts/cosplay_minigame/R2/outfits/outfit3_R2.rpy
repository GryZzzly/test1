...
label outfit3_R2_label:
    ...
    if outfit3_R2_1stTime == True:
        ...
        Caroline "Этот следующий немного странный, но я подумала, что могу также запасать еще более интересные костюмы."
        MC "Это … сексуальный строитель?"
        Caroline "Молодец!"
        MC "(Ее декольте выглядит чертовски здорово!)"
        Caroline "Готов начать фотографировать?"
        MC "(Я бы хотел потирать свой член между этими грудями.)"
        Caroline "Эй? [player_name]?"
        MC "Хм?"
        Caroline "Я спрашиваю, ты готов начать снимать?"
        MC "О! Да! Просто был … мм … ждущий режим камеры."
