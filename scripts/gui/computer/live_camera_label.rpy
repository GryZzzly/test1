...
label live_camera_label:
    ...
    if celia_invitation_webcam == 1 and day_time == 3 and S_inv_webcam == False:
        show Celia_Invitation_v1_p1
        show screen live_camera_screen
        call screen celia_invitation_screen
    if S_inv_webcam == True and day_time == 3:
        show Sara_Invitation_v1_p1
        show screen live_camera_screen
...
screen live_camera_screen:
    ...
    if celia_in_camweb_contacts == True:
        imagebutton:
            xpos 324
            ypos 247
            focus_mask True
    ...
    if sara_in_camweb_contacts == True:
        imagebutton:
            xpos 516
            ypos 247
            focus_mask True
