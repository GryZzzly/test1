...
screen phone_main_screen:
    ...
    imagebutton:
        ...
        hovered [Play ("sound", "sfx/phone_click.mp3"), Show("displayTextScreen", displayText = "СМС")]
    ...
    imagebutton:
        ...
        hovered [Play ("sound", "sfx/phone_click.mp3"), Show("displayTextScreen", displayText = "Камера")]
        unhovered Hide("displayTextScreen")
        action NullAction()
    ...
    imagebutton:
        ...
        hovered [Play ("sound", "sfx/phone_click.mp3"), Show("displayTextScreen", displayText = "Статистика")]
        unhovered Hide("displayTextScreen")
    ...
    imagebutton:
        ...
        hovered [Play ("sound", "sfx/phone_click.mp3"), Show("displayTextScreen", displayText = "Сайт Patreon")]
        unhovered Hide("displayTextScreen")
