...
label bath_event_menu2:
    ...
    menu:
        "Завершить ванну.":
            ...
            jump bathroom_morning1
        "Мастурбировать и думать о ком-то.":
...
label bath_event_menu3:
    ...
    menu:
        "Мама" if renpy.loadable("patch.rpy"):
            ...
            jump bathroom_morning1
        "Мама" if not renpy.loadable("patch.rpy"):
            scene bath_event_pLinda at pandown3
            $ renpy.pause(5)
            scene bath_event_pLinda at pandown2
            $ renpy.pause(5)
        ...
        "Селия":
            ...
            $ can_hide_windows = False
            jump bathroom_morning1
        "Тетя" if au_bath_event_unlock == True and renpy.loadable("patch.rpy"):
            ...
            $ can_hide_windows = False
            jump bathroom_morning1
        "Тетя" if au_bath_event_unlock == True and not renpy.loadable("patch.rpy"):
            scene bath_event_pAu at pandown3
            $ renpy.pause(5)
            scene bath_event_pAu at pandown2
            $ renpy.pause(5)
            ...
            $ can_hide_windows = False
            jump bathroom_morning1
        "Виолетта" if violet_bath_event_unlock == True:
            ...
            $ can_hide_windows = False
            jump bathroom_morning1
        "Лили" if lily_bath_event_unlock == True:
        ...
        "Зури и Сури " if zuri_bath_event_unlock == True:
