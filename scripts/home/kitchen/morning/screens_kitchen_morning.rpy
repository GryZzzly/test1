screen kitchen_morning:
    ...
    if ml_can_salon_morning_scene_dish_wash == True and ml_points == 1:
        imagebutton:
            ...
            hovered Show("displayTextScreen", displayText = "Мыть посуду")
    ...
    if ml_kitchen_morning_scene == True and  ml_can_kitchen_morning_scene4 == True and ml_points == 1:
        imagebutton:
            ...
            if renpy.loadable("patch.rpy"):
                hovered Show("displayTextScreen", displayText = "Мама и тетя")
            if not renpy.loadable("patch.rpy"):
                hovered Show("displayTextScreen", displayText = "Линда и ее подруга")
