screen sister_nerdy_evening:
    ...
    if sis_nerdy_evening_scene1_v1 == 1 and Sara_points == 1:
        imagebutton:
            xpos 940
            ypos 404
            focus_mask True
    ...
    if sis_nerdy_evening_scene2a_v1 == 1 and Sara_points == 1:
        imagebutton:
            xpos 940
            ypos 404
            focus_mask True
    ...
    if sis_nerdy_evening_gamepad_change_scene3_v1 == 0 and Sara_points == 1 and can_gamepad_sara == True and  can_sis_nerdy_gamepad_change == 1:
        imagebutton:
            ...
            hovered Show("displayTextScreen", displayText = "Геймпад Сары")
            unhovered Hide("displayTextScreen")
