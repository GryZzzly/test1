screen school_corridor1_day:
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Класс 1")
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Туалеты")
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Бассейн")
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Класс 2")
    ...
    if corridor1_door_to_teacher_room2_open == False and celia_key_take==True:
        if celia_key.selected:
            imagebutton:
                ...
                hovered Show("displayTextScreen", displayText = "Комната отдыха учителя (закрыта)")
            ...
            imagebutton:
                ...
                idle "images/school/school_corridor1/morning/door6_morning_idle.png"
                hover "images/school/school_corridor1/morning/door6_morning_hover.png"
                hovered Show("displayTextScreen", displayText = "Комната отдыха (закрыта)")
    ...
    if corridor1_door_to_teacher_room2_open == True:
        imagebutton:
            ...
            idle "images/school/school_corridor1/morning/door6_morning_idle.png"
            hover "images/school/school_corridor1/morning/door6_morning_hover.png"
            hovered Show("displayTextScreen", displayText = "Комната отдыха учителя")
