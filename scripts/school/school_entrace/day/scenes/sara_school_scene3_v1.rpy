...
label after_sis_nerdy_school_scene3_v1_choice2:
    ...
    $ renpy.pause(0.1)
    scene sis_nerdy_school_scene3_v1_p52
    MC "Ах! Ты можете остановиться - я закончил!"

    scene sis_nerdy_school_scene3_v1_p53
    Sara "Wha duh I duh wuh thus?"
    MC "(Я думаю, что она спрашивает, что она делать с моей спермой сейчас.)"
