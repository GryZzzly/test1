...
label empty_envelopev1_label:
    ...
    MC "Мне нужна ручка. У меня, наверное, есть несколько в моем шкафчике в школьном коридоре."
...
label put_dildov1_label:
    ...
    MC "Хорошо. Я должен уйти отсюда. Она даже не заподозрит меня."
    $ day_time += 1
    jump map_label
...
screen locker_b1v1_screen:
    ...
    if sexy_cloth.selected and sexy_cloth in inventory.items and celia_webcam_menuv1 == True:
        imagebutton:
            ...
            hovered Show("displayTextScreen", displayText = "Положите сексуальную ожежду")
            unhovered Hide("displayTextScreen")
