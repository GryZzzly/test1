...
label celia_toilet_cabin_day_scene3_v1_label:
    ...
    Celia "(Он там…)"
    Celia "(Боже ... Я не могу поверить, что мне нужно пройти через это.)"
    Celia "(Вздох...)"

    scene celia_toilet_cabin_day_scene3_v1_p2
    Celia "[player_name]?"
    MC "(Махахаха! В конце концов, она пришла!)"
    MC "Да?! М-миссис Селия?! Что ты здесь делаешь??"

    scene celia_toilet_cabin_day_scene3_v1_p3
    MC "Это мужской туалет! Думаю, ты ошиблась номером!"
    Celia "Это ... не то, для чего я здесь."
    MC "Что ты имеешь в виду?"

    scene celia_toilet_cabin_day_scene3_v1_p4
    MC "(Вау ... она толкнула меня на стену.)"
    MC "Что ты делаешь?"
    Celia "Просто заткнись."

    scene celia_toilet_cabin_day_scene3_v1_p5
    MC "Что происходит? Ты.."
    Celia "Я собираюсь тебя поцеловать. И ты никому не расскажешь. Понял?"
    MC "Но я думал, что ты ненавидишь меня?"
    Celia "Просто заткнись и позволь этому случиться."

    scene celia_toilet_cabin_day_scene3_v1_p6
    MC "(Махахаха! Пока я продолжаю играть невинно, она не знает, кому верить или как реагировать!)"
    MC "(Теперь, когда я знаю, что она хочет поцеловать меня, возможно, я смогу заставить ее заняться более дурными вещами в будущем?)"

    scene celia_toilet_cabin_day_scene3_v1_p7
    Celia "Mмм…"
    MC "Mмм!"
    Celia "(Боже ... Я не могу поверить, что меня шантажируют.)"

    scene celia_toilet_cabin_day_scene3_v1_p8
    Celia "(Когда я найду этого ублюдка, у которого есть та фотография, я сломаю его гребаные ноги!)"
    Celia "(Это должно быть одно из самых унизительных переживаний моей жизни! Это даже хуже, чем лесбийские издевательства в моем доме!)"
    MC "Mмм!"

    scene celia_toilet_cabin_day_scene3_v1_p9
    MC "(Она правильно целует меня!)"
    MC "(И она, кажется, не возражает против моих рук на заднице!)"
    MC "(Давай посмотрим, как она отреагирует, если я подниму ее юбку.)"

    scene celia_toilet_cabin_day_scene3_v1_p10
    Celia "(Гах! Этот маленький извращенец поднимает мою юбку. Но если я попытаюсь остановить его, тот шантажирующий ублюдок выложит фото.)"
    Celia "(Мне просто придется терпеть это.)"

    scene celia_toilet_cabin_day_scene3_v1_p11
    Celia "(Ладно, это продолжается достаточно долго. Я сделала больше, чем меня просили.)"
    Celia "(Я надеюсь, что та ползучая тварь защитает это…)"

    scene celia_toilet_cabin_day_scene3_v1_p12
    MC "Вау! Для чего это было, миссис Селия??"
    Celia "Заткнись."
    MC "Хмм?"
    Celia "Не говори никому ни слова об этом."
    MC "Я смущен."

    scene celia_toilet_cabin_day_scene3_v1_p13
    Celia "Это наш маленький секрет."
    MC "Правда? Будет ли это снова?"
    Celia "(Я очень надеюсь, что нет!)"
    Celia "…"

    scene celia_toilet_cabin_day_scene3_v1_p14
    MC "(Ахахаха! Это сработало! Ее техника поцелуя потрясающая!)"
    MC "(Теперь я могу попробовать, подталкнуть ее на другие поступки!)"
