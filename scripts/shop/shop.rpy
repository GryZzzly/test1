...
label shop_label:
    ...
    if day_time == 2:
        ...
        MC "Закрыто. Он открыт только утром и днем."
        jump map_label
...
screen shop_open_screen:
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Полка")
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Алкогольная полка")
        unhovered Hide("displayTextScreen")
    ...
    imagebutton:
        ...
        hovered Show("displayTextScreen", displayText = "Выход")
        unhovered Hide("displayTextScreen")
